...
<style>
  ...
  #notify-card { font-family: 'Inter', system-ui, sans-serif; }
</style>
...
(function() {
  ...
  card.className = `
    ...
    rounded-3xl shadow-2xl border border-zinc-700 overflow-hidden
  ...
  card.innerHTML = `
    <div class="p-6 relative">
      ...
      <div class="space-y-3">
        <a href="https://whatsapp.com/channel/0029Vb7izReKAwEfwz7Ixl1q" target="_blank"
           class="flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] 
                  text-white font-medium py-4 px-6 rounded-2xl transition-all active:scale-95">
        ...
        <a href="https://t.me/diplomacampus" target="_blank"
